...
/*   Updated: 2024/12/18 16:49:13 by alfokin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	printf("Normal Test\n");
	printf("sys: ");
	printf_count = printf("%x", pos_hex);
	printf(" | my: ");
	fflush(stdout);
	ft_printf_count = ft_printf("%x", pos_hex);
	printf("\nsys_len: %d | my_len: %d\n", printf_count, ft_printf_count);
	...
	printf("Negative Number Test\n");
	printf("sys: ");
	printf_count = printf("%x", 9223372036854775807LL);
	printf(" | my: ");
	fflush(stdout);
	ft_printf_count = ft_printf("%x", 9223372036854775807LL);
	printf("\nsys_len: %d | my_len: %d\n", printf_count, ft_printf_count);
	...
	printf("Negative Number Test\n");
	printf("sys: ");
	printf_count = printf("%X", up_hex);
	printf(" | my: ");
	fflush(stdout);
	ft_printf_count = ft_printf("%X", up_hex);
	printf("\nsys_len: %d | my_len: %d\n", printf_count, ft_printf_count);
