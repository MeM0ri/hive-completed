...
/*   Updated: 2025/02/14 18:09:57 by alfokin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		t_stack *stack_data, int max)
{
	if (stack_data->stack[stack_data->top] == max)
	{
		...
		//swap_a(data);
		rotate_a(data);
		if (stack_data->stack[next_index(stack_data, stack_data->top)] != max - 1)
			swap_a(data);
		// swap_a(data);
		...
		t_stack *stack_data, int max)
{
	...
	if (stack_data->stack[stack_data->top] == max)
	{
		...
		== max)
	{
		//("sort_three_top_b / else if (stack_data->stack[next_index(stack_data, stack_data->top)]== max)\n");
